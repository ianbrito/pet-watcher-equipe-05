        ...
        <div class="wrap-new-entry-lic">
            <form action="{{ action('AnimalController@store') }}" method="post" class="nwe100-form validate-form">
                ...
                <div class="wrap-input100 validate-input">
                    <select class="form-control input100" id="tipo_aquisicao" name="tipo_aquisicao" placeholder="Tipo de aquisição">
                ...
                <div class="wrap-input100 validate-input">
                    <input type="text" class="form-control input100" id="proprietario_id" name="proprietario_id" placeholder="ID do Proprietário">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                ...
                <div id="pedigree_infos">
                    <div class="wrap-input100 validate-input" id="pedigree_codigo">
                        <input type="text" class="form-control input100" id="codigo_pedigree" name="codigo_pedigree" placeholder="Código (Pedigree)">
                        <span class="focus-input100"></span>
                        <span class="symbol-input100">
