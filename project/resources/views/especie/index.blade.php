...
<table border="solid">
    ...
    @foreach($especies as $especie)
        <tr>
            ...
            <td>
                <form action="{{ action('EspecieController@destroy', $especie->id) }}" method="post" onsubmit="return confirm('Você deseja deletar este registro (&quot;{{ $especie->especie }}&quot;) do sistema?')">
                    @csrf
                    {{ method_field('delete') }}
